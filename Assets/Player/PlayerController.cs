...
public class PlayerController : MonoBehaviour
{
  ...
  /*  void Movin()
    ...
    }*/ //SmoothRandom control

    void Movin()
    {
        Vector2 targetPosition = rb.position + movement * moveSpeed * slower * isRunning * Time.fixedDeltaTime;
    ...
    // Nyomva van-e WASD billentyû valamelyike
    private bool CheckWASDKeys()
    {
        bool isW, isA, isS, isD;
        bool isWASD = false;
        /*
        isW = (Input.GetKeyDown(KeyCode.W));
        isA = (Input.GetKeyDown(KeyCode.A));
        isS = (Input.GetKeyDown(KeyCode.S));
