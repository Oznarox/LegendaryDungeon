...
public class RandomWarp : MonoBehaviour
{
    ...
    [SerializeField] public string exitScene; // Színpad neve
    [SerializeField] public List<string> randomScenes; // Színpadok nevei
    ...
    [SerializeField] public string targetScene; // Cél szín neve
